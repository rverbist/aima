...
public final class SquaredEuclideanDistanceHeuristicFunction implements HeuristicFunction
{
    @Override
    public double h(Object state)
    {
        ...
        return Math.pow(actor.getX() - finish.getX(), 2) + Math.pow(actor.getY() - finish.getY(), 2);
    }
}